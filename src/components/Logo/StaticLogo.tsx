...
const StaticLogo = ({primaryColor = '#0068B3', secondaryColor = '#FAA21B', size = '100px'}: IProps) => (
    <Logo size={size} viewBox="0 0 141 112" fill="none">
        <g clip-path="url(#clip0)">
            ...
            78.3412L22.213 83.8012Z" fill={primaryColor}/>
            <path d="M119.318 28.3892C115.542 21.3053 106.657 10.6523 93.0622 4.69773C79.4677 -1.25682 64.0666 -1.56244
            ...
            28.3892Z" fill={primaryColor}/>
            <path d="M70.3601 31.1052L74.2768 56.1652L140.86 24.2453L63.7857 83.6052L60.5685 61.2052L0 87.6652L70.3601
            31.1052Z" fill={secondaryColor}/>
        </g>
        <defs>
            <clipPath id="clip0">
